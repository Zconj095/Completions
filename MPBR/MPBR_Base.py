...
class BrainwaveAnalyzer:
    ...
    def calculate_wavelength_metrics(self, data: Dict) -> Dict:
        ...
        # Core calculations
        pulse_frequency_decimal = Decimal(str(pulse_frequency))
        wavelength = self.speed_of_light / pulse_frequency_decimal
        ...
        metrics = {
            ...
            'energy_density': Decimal(str(pulse_amplitude ** 2)) / wavelength
        }
